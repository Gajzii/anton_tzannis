...
<div class="page-margin">
    ...
    <div class="product_card" style="background-color: white;">
...
<?php get_footer(); ?>
        ...
        <!-- <script>
            const readMoreBtns = document.querySelectorAll('.primary-btn');

            // Opens modal when click on a button with the correct href
            readMoreBtns.forEach(function (i) {
